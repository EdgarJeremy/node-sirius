                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="88%" style="width: 88% !important; min-width: 88%; max-width: 88%;">
                            <tr>
                                <td align="center" valign="top">
                                    ...
                                    <h1 style="font-size: 50px;font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; font-weight: lighter">MapSurvey</h1>
                                    <!--                         <a href="#"
                        style="display: block; max-width: 192px;">
                          <img src="http://hireclub.com/images/email_logo.png" alt="HireClub" width="192"
                            ...
                            <tr>
                                <td align="left" valign="top">
                                    <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 54px; font-weight: 300; letter-spacing: -1.5px;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 54px; font-weight: 300; letter-spacing: -1.5px;">Informasi
                                            Pendaftaran</span>
                                    </font>
                                    ...
                                    <font face="'Source Sans Pro', sans-serif" color="#000000" style="font-size: 20px; line-height: 28px;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 20px; line-height: 28px;">
                                            ...
                                            Gunakan informasi dibawah untuk login pertama kali. <br /><br />
                                            Username : <b>${config.username}</b> <br />
                                            Password : <b>${config.password}</b><br /><br />
                                            Pastikan mengganti password anda saat login pertama ini demi alasan
                                            keamanan. <br />
                            ...
                            <tr>
                                <td align="left" valign="top">
                                    <font face="'Source Sans Pro', sans-serif" color="#7f7f7f" style="font-size: 17px; line-height: 23px;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #7f7f7f; font-size: 17px; line-height: 23px;">Copyright
